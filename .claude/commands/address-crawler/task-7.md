# address-crawler - Task 7

Execute task 7 for the address-crawler specification.

## Task Description
Create AddressInfo model with SQLAlchemy
...
## Usage
```
/Task:7-address-crawler
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create AddressInfo model with SQLAlchemy"

```
Use the @spec-task-executor agent to implement task 7: "Create AddressInfo model with SQLAlchemy" for the address-crawler specification and include all the below context.
...
## Task Details
- Task ID: 7
- Description: Create AddressInfo model with SQLAlchemy
- Requirements: 2.1, 2.2

## Instructions
- Implement ONLY task 7: "Create AddressInfo model with SQLAlchemy"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks address-crawler 7 --mode complete
...
```bash
claude-code-spec-workflow get-tasks address-crawler 7 --mode complete
```
