# address-crawler - Task 36

Execute task 36 for the address-crawler specification.
...
## Usage
```
/Task:36-address-crawler
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create end-to-end workflow tests"

```
Use the @spec-task-executor agent to implement task 36: "Create end-to-end workflow tests" for the address-crawler specification and include all the below context.
...
## Task Details
- Task ID: 36
- Description: Create end-to-end workflow tests
- Requirements: All

## Instructions
- Implement ONLY task 36: "Create end-to-end workflow tests"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks address-crawler 36 --mode complete
...
```bash
claude-code-spec-workflow get-tasks address-crawler 36 --mode complete
```
