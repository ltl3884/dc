# address-crawler - Task 29

Execute task 29 for the address-crawler specification.
...
## Usage
```
/Task:29-address-crawler
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create log rotation and cleanup utilities"

```
Use the @spec-task-executor agent to implement task 29: "Create log rotation and cleanup utilities" for the address-crawler specification and include all the below context.
...
## Task Details
- Task ID: 29
- Description: Create log rotation and cleanup utilities
- Requirements: 5.3, 7.4

## Instructions
- Implement ONLY task 29: "Create log rotation and cleanup utilities"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks address-crawler 29 --mode complete
...
```bash
claude-code-spec-workflow get-tasks address-crawler 29 --mode complete
```
