# address-crawler - Task 32

Execute task 32 for the address-crawler specification.

## Task Description
Create integration tests for TaskService
...
## Usage
```
/Task:32-address-crawler
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create integration tests for TaskService"

```
Use the @spec-task-executor agent to implement task 32: "Create integration tests for TaskService" for the address-crawler specification and include all the below context.
...
## Task Details
- Task ID: 32
- Description: Create integration tests for TaskService
- Requirements: 4.1, 4.2, 4.3

## Instructions
- Implement ONLY task 32: "Create integration tests for TaskService"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks address-crawler 32 --mode complete
...
```bash
claude-code-spec-workflow get-tasks address-crawler 32 --mode complete
```
