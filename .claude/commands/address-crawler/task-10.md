# address-crawler - Task 10

Execute task 10 for the address-crawler specification.

## Task Description
Create TaskService for task management
...
## Usage
```
/Task:10-address-crawler
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create TaskService for task management"

```
Use the @spec-task-executor agent to implement task 10: "Create TaskService for task management" for the address-crawler specification and include all the below context.
...
## Task Details
- Task ID: 10
- Description: Create TaskService for task management
- Requirements: 4.1, 4.2, 4.3

## Instructions
- Implement ONLY task 10: "Create TaskService for task management"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks address-crawler 10 --mode complete
...
```bash
claude-code-spec-workflow get-tasks address-crawler 10 --mode complete
```
