# address-crawler - Task 12

Execute task 12 for the address-crawler specification.
...
## Usage
```
/Task:12-address-crawler
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create data validation service"

```
Use the @spec-task-executor agent to implement task 12: "Create data validation service" for the address-crawler specification and include all the below context.
...
## Task Details
- Task ID: 12
- Description: Create data validation service
- Requirements: 6.1, 6.2, 6.3, 6.4

## Instructions
- Implement ONLY task 12: "Create data validation service"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks address-crawler 12 --mode complete
...
```bash
claude-code-spec-workflow get-tasks address-crawler 12 --mode complete
```
