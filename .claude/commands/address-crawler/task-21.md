# address-crawler - Task 21

Execute task 21 for the address-crawler specification.
...
## Usage
```
/Task:21-address-crawler
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create database initialization script"

```
Use the @spec-task-executor agent to implement task 21: "Create database initialization script" for the address-crawler specification and include all the below context.
...
## Instructions
- Implement ONLY task 21: "Create database initialization script"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks address-crawler 21 --mode complete
...
```bash
claude-code-spec-workflow get-tasks address-crawler 21 --mode complete
```
