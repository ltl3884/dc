# address-crawler - Task 14

Execute task 14 for the address-crawler specification.

## Task Description
Create service initialization and imports
...
## Usage
```
/Task:14-address-crawler
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create service initialization and imports"

```
Use the @spec-task-executor agent to implement task 14: "Create service initialization and imports" for the address-crawler specification and include all the below context.
...
## Task Details
- Task ID: 14
- Description: Create service initialization and imports
- Requirements: 3.1

## Instructions
- Implement ONLY task 14: "Create service initialization and imports"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks address-crawler 14 --mode complete
...
```bash
claude-code-spec-workflow get-tasks address-crawler 14 --mode complete
```
