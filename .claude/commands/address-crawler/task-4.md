# address-crawler - Task 4

Execute task 4 for the address-crawler specification.
...
## Usage
```
/Task:4-address-crawler
```

## Instructions

Execute with @spec-task-executor agent the following task: "Set up database connection utilities"

```
Use the @spec-task-executor agent to implement task 4: "Set up database connection utilities" for the address-crawler specification and include all the below context.
...
## Task Details
- Task ID: 4
- Description: Set up database connection utilities
- Requirements: 1.4, 2.2

## Instructions
- Implement ONLY task 4: "Set up database connection utilities"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks address-crawler 4 --mode complete
...
```bash
claude-code-spec-workflow get-tasks address-crawler 4 --mode complete
```
