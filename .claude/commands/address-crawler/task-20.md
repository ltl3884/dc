# address-crawler - Task 20

Execute task 20 for the address-crawler specification.
...
## Usage
```
/Task:20-address-crawler
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create main application runner"

```
Use the @spec-task-executor agent to implement task 20: "Create main application runner" for the address-crawler specification and include all the below context.
...
## Task Details
- Task ID: 20
- Description: Create main application runner
- Requirements: 1.3, 3.1, 3.2

## Instructions
- Implement ONLY task 20: "Create main application runner"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks address-crawler 20 --mode complete
...
```bash
claude-code-spec-workflow get-tasks address-crawler 20 --mode complete
```
