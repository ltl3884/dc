# address-crawler - Task 31

Execute task 31 for the address-crawler specification.

## Task Description
Create basic unit tests for AddressInfo model
...
## Usage
```
/Task:31-address-crawler
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create basic unit tests for AddressInfo model"

```
Use the @spec-task-executor agent to implement task 31: "Create basic unit tests for AddressInfo model" for the address-crawler specification and include all the below context.
...
## Task Details
- Task ID: 31
- Description: Create basic unit tests for AddressInfo model
- Requirements: 2.1, 2.2

## Instructions
- Implement ONLY task 31: "Create basic unit tests for AddressInfo model"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks address-crawler 31 --mode complete
...
```bash
claude-code-spec-workflow get-tasks address-crawler 31 --mode complete
```
