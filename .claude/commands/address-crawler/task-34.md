# address-crawler - Task 34

Execute task 34 for the address-crawler specification.

## Task Description
Create integration tests for DataService
...
## Usage
```
/Task:34-address-crawler
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create integration tests for DataService"

```
Use the @spec-task-executor agent to implement task 34: "Create integration tests for DataService" for the address-crawler specification and include all the below context.
...
## Task Details
- Task ID: 34
- Description: Create integration tests for DataService
- Requirements: 2.1, 2.2, 2.3, 6.1, 6.2, 6.3, 6.4

## Instructions
- Implement ONLY task 34: "Create integration tests for DataService"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks address-crawler 34 --mode complete
...
```bash
claude-code-spec-workflow get-tasks address-crawler 34 --mode complete
```
