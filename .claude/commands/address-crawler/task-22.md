# address-crawler - Task 22

Execute task 22 for the address-crawler specification.
...
## Usage
```
/Task:22-address-crawler
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create environment configuration template"

```
Use the @spec-task-executor agent to implement task 22: "Create environment configuration template" for the address-crawler specification and include all the below context.
...
## Instructions
- Implement ONLY task 22: "Create environment configuration template"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks address-crawler 22 --mode complete
...
```bash
claude-code-spec-workflow get-tasks address-crawler 22 --mode complete
```
