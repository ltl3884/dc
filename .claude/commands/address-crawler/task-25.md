# address-crawler - Task 25

Execute task 25 for the address-crawler specification.

## Task Description
Implement logging in CrawlerService
...
## Usage
```
/Task:25-address-crawler
```

## Instructions

Execute with @spec-task-executor agent the following task: "Implement logging in CrawlerService"

```
Use the @spec-task-executor agent to implement task 25: "Implement logging in CrawlerService" for the address-crawler specification and include all the below context.
...
## Task Details
- Task ID: 25
- Description: Implement logging in CrawlerService
- Requirements: 5.3, 5.4

## Instructions
- Implement ONLY task 25: "Implement logging in CrawlerService"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks address-crawler 25 --mode complete
...
```bash
claude-code-spec-workflow get-tasks address-crawler 25 --mode complete
```
