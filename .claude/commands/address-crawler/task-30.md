# address-crawler - Task 30

Execute task 30 for the address-crawler specification.

## Task Description
Create basic unit tests for Task model
...
## Usage
```
/Task:30-address-crawler
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create basic unit tests for Task model"

```
Use the @spec-task-executor agent to implement task 30: "Create basic unit tests for Task model" for the address-crawler specification and include all the below context.
...
## Task Details
- Task ID: 30
- Description: Create basic unit tests for Task model
- Requirements: 4.1, 4.2

## Instructions
- Implement ONLY task 30: "Create basic unit tests for Task model"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks address-crawler 30 --mode complete
...
```bash
claude-code-spec-workflow get-tasks address-crawler 30 --mode complete
```
