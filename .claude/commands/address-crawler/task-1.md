# address-crawler - Task 1

Execute task 1 for the address-crawler specification.
...
## Usage
```
/Task:1-address-crawler
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create pyproject.toml with project dependencies"

```
Use the @spec-task-executor agent to implement task 1: "Create pyproject.toml with project dependencies" for the address-crawler specification and include all the below context.
...
## Task Details
- Task ID: 1
- Description: Create pyproject.toml with project dependencies
- Requirements: 1.1

## Instructions
- Implement ONLY task 1: "Create pyproject.toml with project dependencies"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks address-crawler 1 --mode complete
...
```bash
claude-code-spec-workflow get-tasks address-crawler 1 --mode complete
```
