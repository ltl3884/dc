# address-crawler - Task 27

Execute task 27 for the address-crawler specification.
...
## Usage
```
/Task:27-address-crawler
```

## Instructions

Execute with @spec-task-executor agent the following task: "Implement logging in scheduler"

```
Use the @spec-task-executor agent to implement task 27: "Implement logging in scheduler" for the address-crawler specification and include all the below context.
...
## Task Details
- Task ID: 27
- Description: Implement logging in scheduler
- Requirements: 7.1, 7.2

## Instructions
- Implement ONLY task 27: "Implement logging in scheduler"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks address-crawler 27 --mode complete
...
```bash
claude-code-spec-workflow get-tasks address-crawler 27 --mode complete
```
