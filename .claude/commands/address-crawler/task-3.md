# address-crawler - Task 3

Execute task 3 for the address-crawler specification.
...
## Usage
```
/Task:3-address-crawler
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create Flask application factory"

```
Use the @spec-task-executor agent to implement task 3: "Create Flask application factory" for the address-crawler specification and include all the below context.
...
## Task Details
- Task ID: 3
- Description: Create Flask application factory
- Requirements: 1.3

## Instructions
- Implement ONLY task 3: "Create Flask application factory"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks address-crawler 3 --mode complete
...
```bash
claude-code-spec-workflow get-tasks address-crawler 3 --mode complete
```
